...
img_dir = "/root/autodl-tmp/MPIIFaceGaze-new/Image/p00/face"
visual_img = Image.open("/root/autodl-tmp/MPIIFaceGaze-new/Image/p00/face/1.jpg").convert('RGB')
# visual_img = Image.open("/root/autodl-tmp/eyediap/Image/p1/face/1.jpg").convert('RGB')
# img_dir = "/root/autodl-tmp/Columbia/Image/train4"
# visual_img = Image.open("/root/autodl-tmp/Columbia/Image/train4/0045_2m_0P_0V_0H.jpg")

images=os.listdir(img_dir)

model = resnet18(domains=75)
mlp = Gaze_regressor()

statedict = torch.load("/root/autodl-tmp/dg/result/eth/checkpoint/Iter_1_dg.pt")
# statedict = torch.load("/root/autodl-tmp/byol/result/mpii/checkpoint/p14.label/Iter_80_dg.pt")
# statedict = torch.load("/root/autodl-tmp/dg/result/gaze360/checkpoint/Iter_20_dg.pt")

model.load_state_dict(statedict['resnet18'])
mlp.load_state_dict(statedict['mlp'])
